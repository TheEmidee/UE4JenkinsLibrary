    ...
    parsers.each { item -> 
        ...
        try {
            timeout(time: 120, unit: 'SECONDS') {
                ...
                def issues = scanForIssues blameDisabled: true, forensicsDisabled: true, tool: groovyScript(parserId: "${parser.ParserName}", id: "${parser_id}", name: "${parser_id}", pattern: "${log_file_path}", reportEncoding: 'UTF-8')
