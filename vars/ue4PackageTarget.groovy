...
def call( String type, String platform, ue4_config, buildgraph_params ) {
    ...
    stage( buildgraph_task_name ) {
        ...
        recordIssues(tools: [groovyScript(id: "BuildCookRun_${type}_${platform}", name: "BuildCookRun_${type}_${platform}", parserId: 'UE4_BuildCookRun', pattern: 'Saved/Logs/Log.txt')], , failOnError: true, filters: [], qualityGates: [[threshold: 1, type: 'TOTAL', unstable: true]])
